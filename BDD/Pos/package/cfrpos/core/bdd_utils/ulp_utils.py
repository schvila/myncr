...
from cfrpos.core.bdd_utils.promotion_utils import *
from cfrpos.core.bdd_utils.timeouter import timeouter

class UlpNepSimFacade():
    """Helper class for using the NepSvcsSimControl for ULP simulation
    """
    ...
    def wait_for_message_with_elements(self, action: str, comparator: MessageComparator, elements: dict, timeout: int) -> dict:
        ...
        def get_msg():
            messages = self.simulator.get_trapped_messages(action, PromotionsSim.ULP)
