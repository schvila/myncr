...
function initializeRoutes(app, simulatorContext) {
    let commonPromotion = new CommonPromotion_1.CommonPromotion('UnifiedLoyaltyPromotions', simulatorContext);
    /**
      * @swagger
      ...
      *                          type: string
      */
    app.post('/ret-ulp/execution/v2/promotions', (req, res, next) => commonPromotion.getPromotions(req, res, next));
    /**
      * @swagger
      ...
      *              description: Success.
      */
    app.post('/ret-ulp/execution/v2/finalize', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.finalize(req, res));
    /**
     * @swagger
     ...
     *              description: Success.
     */
    app.post('/ret-ulp/execution/v2/void', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.voidPromotion(req, res));
    // ---------------------------------------------------
     ...
     *                          type: string
     */
    app.post('/ret-ulp/simulator/configuration', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.configure(req, res));
    /**
     * @swagger
     ...
     *                          type: string
     */
    app.get('/ret-ulp/simulator/messages', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.getMessages(req, res));
    /**
     * @swagger
     * /ret-ulp/simulator/messages:
     *  delete:
     ...
     *                          type: string
     */
    app.delete('/ret-ulp/simulator/messages', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.deleteMessages(req, res));
    /**
     * @swagger
     ...
     *                          type: string
     */
    app.get('/ret-ulp/simulator/capture-trap', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.captureTrap(req, res));
    /**
     * @swagger
     ...
     */
    app.get('/ret-ulp/simulator/delay-trap', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.delayTrap(req, res));
    /**
     * @swagger
     ...
     */
    app.delete('/ret-ulp/simulator/trap', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.deleteTrap(req, res));
    /**
     * @swagger
     ...
     */
    app.get('/ret-ulp/simulator/waitForMessages', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.waitForMessages(req, res));
    /**
     * @swagger
     ...
     *              description: Missing "trapId" element.
     */
    app.delete('/ret-ulp/simulator/trappedMessages', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.deleteTrap(req, res));
    /**
     * @swagger
     ...
     */
    app.post('/ret-ulp/simulator/customStatusCode', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.addCustomStatusCode(req, res));
    /**
     * @swagger
     * /ret-ulp/simulator/customStatusCode:
     *  delete:
     ...
     *                          type: string
     */
    app.delete('/ret-ulp/simulator/customStatusCode', ServiceCommon_1.skipIfDummyMode(simulatorContext), (req, res) => commonPromotion.deleteCustomStatusCode(req, res));
}
exports.initializeRoutes = initializeRoutes;
//# sourceMappingURL=UnifiedLoyaltyPromotion.js.map