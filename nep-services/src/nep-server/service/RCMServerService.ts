...
export function initializeRoutes(app, simulatorContext: Context) {
     ...
     *                          type: string
     */
    app.post('/rcm/rsl-access-point', skipIfDummyMode(simulatorContext),
     ...
     */
    app.get('/RCMHostServices/File', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
     ...
     *                          type: string
     */
    app.get('/rcm/site-transform', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
     ...
     *              description: Success
     */
    app.post('/rcm/simulator/messages', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
        messages.push({
            response: req.body,
     ...
     *              description: Success
     */
    app.delete('/rcm/simulator/messages', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
        messages = [];
     ...
     *
     */
    app.post('/rcm/simulator/messages/download-request', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
     ...
     *              description: Success
     */
    app.post('/rcm/simulator/files', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
     ...
     *              description: Success
     */
    app.delete('/rcm/simulator/files', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
     ...
     *              description: Success
     */
    app.put('/rcm/simulator/site-transform', skipIfDummyMode(simulatorContext), (req: express.Request, res: express.Response): void => {
        siteTransformXml = req.body;
        res.status(204).end();
    });
};

function makeDownloadXmlMessage(siteId: string, updateId: string) {
    let files = '';
